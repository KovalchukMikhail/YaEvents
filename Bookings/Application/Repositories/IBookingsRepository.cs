...
namespace Application.Repositories
{
    public interface IBookingsRepository
    {
        ...
        public Task<bool> Cancel(Guid id, CancellationToken token = default);
        public Task<Booking[]> GetBookings(Guid userId, Guid eventId, CancellationToken token = default);
    }
}
