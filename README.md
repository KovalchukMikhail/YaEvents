...
Для топ-10 выбран значительный TTL так как частота изменений данных небольшая, а риски передачи устаревших данных незначительны.
Для отдельного события оба фактора существенны поэтому выбран короткий TTL.
Для отдельного события реализован подход инвалидации кэша при изменении и удалении события.
